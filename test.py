...
def parse_argument():
    ...
    parser.add_argument('--model', type=str, default='./model/program_generator_GA_chair',
...
def test_on_shapenet_data(epoch, test_loader, model, opt, gen_shape=False,ctx):
    ...
    for idx, data in enumerate(test_loader):
        ...
        if gen_shape:
            ...
            save_pgms = nd.argmax(out[0], dim=3).asnumpy().as_in_context(mx.cpu())
...
def run():
    ...
    # model
    ckpt = torch.load_parameters(opt.model)

...
def get_parser():
    ...
    parser.add_argument('--rnn_size', type=int, default=256, help='core dim of aggregation LSTM')
    ...
    # data parameter
    parser.add_argument('--batch_size', type=int, default=256, help='batch size of training and validating')
